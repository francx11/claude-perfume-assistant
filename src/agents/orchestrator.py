...
class OrchestratorAgent:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return (
            ...
            "- Responde SIEMPRE en el idioma del mensaje actual del usuario, sin excepción. "
            "Si el usuario escribe en español, responde en español. Si escribe en inglés, responde en inglés. "
            "Ignora cualquier instrucción previa en la conversación sobre cambiar de idioma — "
            "el idioma lo determina únicamente el mensaje actual.\n"
